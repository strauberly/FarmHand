...
//
//            statement.executeUpdate("CREATE TABLE IF NOT EXISTS hourly " +
//                    " (hourly_id_ INTEGER PRIMARY KEY AUTOINCREMENT, timestamp TIME , pressure DOUBLE, temperature DOUBLE, wind DOUBLE, humidity DOUBLE, observable_time STRING)");
//            statement.executeUpdate("CREATE TABLE IF NOT EXISTS daily " +
//                    " (daily_id_ INTEGER PRIMARY KEY AUTOINCREMENT, daily_timestamp TIME, high_temp DOUBLE, low_temp DOUBLE, avg_temp DOUBLE," +
//                    "high_wind DOUBLE, avg_wind DOUBLE, avg_humid DOUBLE, high_pressure DOUBLE, low_pressure DOUBLE, avg_pressure DOUBLE, observable_date STRING)");
//
//            statement.executeUpdate("CREATE TABLE IF NOT EXISTS weekly " +
//                    " (weekly_id_ INTEGER PRIMARY KEY AUTOINCREMENT, weekly_timestamp TIME, high_temp DOUBLE, low_temp DOUBLE, avg_temp DOUBLE," +
//                    "high_wind DOUBLE, avg_wind DOUBLE, avg_humid DOUBLE, high_pressure DOUBLE, low_pressure DOUBLE, avg_pressure DOUBLE, observable_week_ending STRING)");
//
//            statement.close();
//            conn.close();
...
//    }
//
//    public static String convertedCurrentDate() {
...
//        return convertedCurrentDate().equals(WDBDaily.convertedLoggedDate(WDBDaily.getLoggedDate()));
//    }
//
//    public static void log() {
//        if ( WeatherDB.getID("daily_id_","daily", WDBDaily.getDailyEntries) == 2){
//            WDBWeekly.writeToWeekly();
//            WeatherDB.resetTable("daily");
//            WDBDaily.writeToDaily();
//            WeatherDB.resetTable("hourly");
//            WDBHourly.writeToHourly();
//        }else if (!WeatherDB.compareDates() && WeatherDB.getID("hourly_id_", "hourly", WDBHourly.getHourlyEntries) > 0){
//            WDBDaily.writeToDaily();
//            WeatherDB.resetTable("hourly");
//            WDBHourly.writeToHourly();
//        }else
