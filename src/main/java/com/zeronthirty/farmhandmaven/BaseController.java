...
public class BaseController {
   ...
   private static String nameOfStage ;
...
//    public void setStage (Stage stageName, String fileName, MouseEvent mouseEvent) throws IOException {
//        nameOfStage = stageName.toString();
//        final double[] xOffset = {0};
//        final double[] yOffset = {0};
//        stageName.initStyle(StageStyle.TRANSPARENT);
...
//
//        root.setOnMouseDragged(event -> {
//            stageName.setX(event.getScreenX() - xOffset[0]);
//            stageName.setY(event.getScreenY() - yOffset[0]);
//
//        });
//    }
//
//    public static String getNameOfStage() {
//        return nameOfStage;
//    }
}